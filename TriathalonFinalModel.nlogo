...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [pcolor = green or pcolor = orange]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [pcolor = red]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [pcolor = brown]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [pcolor = yellow or pcolor = lime or pcolor = grey]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count turtles with [pcolor = brown or pcolor = red]"
...
@#$#@#$#@
<experiments>
  <experiment name="Varying Distances" repetitions="3" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>count turtles with [pcolor = blue]</metric>
    <metric>count turtles with [pcolor = green or pcolor = orange]</metric>
    <metric>count turtles with [pcolor = red or pcolor = brown]</metric>
    <metric>count turtles with [pcolor = grey or pcolor = yellow or pcolor = lime]</metric>
    <enumeratedValueSet variable="yfopens-waves-num">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="oclys-start-wave">
      <value value="9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mpremiers-start-wave">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="omopens-start-wave">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mpremiers-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <steppedValueSet variable="bike-dist" first="30000" step="10000" last="50000"/>
    <steppedValueSet variable="run-dist" first="5000" step="5000" last="15000"/>
    <enumeratedValueSet variable="mpros-start-wave">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ofopens-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="oclys-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="omopens-waves-num">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yclys-start-wave">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="mpros-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ymopens-start-wave">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fpremiers-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yclys-waves-num">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yaths-start-wave">
      <value value="9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yaths-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <steppedValueSet variable="swim-dist" first="500" step="1000" last="2500"/>
    <enumeratedValueSet variable="fpremiers-start-wave">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="yfopens-start-wave">
      <value value="7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fpros-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ymopens-waves-num">
      <value value="4"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="oaths-start-wave">
      <value value="9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="fpros-start-wave">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="ofopens-start-wave">
      <value value="9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="oaths-waves-num">
      <value value="1"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
